...
The suggestion function, in turn, manages to pick out relevant content items that coincide in language, genre and production country with the item liked by the user.
